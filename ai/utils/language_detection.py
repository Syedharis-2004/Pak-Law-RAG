...
def detect_language(text: str) -> str:
    ...
    has_arabic_script = any(u"\u0600" <= char <= u"\u06FF" for char in text)
    has_devanagari_script = any(u"\u0900" <= char <= u"\u097F" for char in text)
    ...
    try:
        ...
        if top_lang.lang == "ur":
            ...
            return "hi"
        elif top_lang.lang in ("en", "no", "tl", "af"):  # Common false positives for Roman Urdu
            # Check if it looks like Roman Urdu (lexical heuristics)
            roman_urdu_words = {"kia", "kya", "hai", "hain", "aur", "pe", "se", "ka", "ki", "ko", "kar", "gaya", "tha", "raha", "he", "ho"}
